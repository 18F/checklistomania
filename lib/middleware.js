...
function includeBranding(req, res, next) {
  res.locals.logoPath = env.BRAND_LOGO_PATH || '/private/img/18F-Logo-M.png';
  res.locals.headerColor = env.BRAND_HEADER_COLOR || '#B3EFFF';
  next();
}
